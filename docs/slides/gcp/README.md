# Slides for Packer Workshops that Target GCP
Slides for all Packer workshops that target GCP should be created using [Remark](https://remarkjs.com) and placed under this directory.
